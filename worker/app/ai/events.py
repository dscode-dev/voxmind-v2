...
# Structural validation of the response (PR-CUT-01)
AI_VALIDATION_FAILED = "AI_VALIDATION_FAILED"
AI_REPAIR_ATTEMPTED = "AI_REPAIR_ATTEMPTED"
...
_LEVEL_BY_EVENT = {
    ...
    AI_REPAIR_ATTEMPTED: "warning",
    AI_REPAIR_SUCCESS: "info",
    AI_REPAIR_FAILED: "error",
}
