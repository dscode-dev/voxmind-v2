                ...
                videos.append(
                    {
                        ...
                        "post": {
                            ...
                            "hook_start": float(post.get("hook_start")) if post.get("hook_start") not in (None, "") else None,
                            "hook_end": float(post.get("hook_end")) if post.get("hook_end") not in (None, "") else None,
